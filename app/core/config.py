...
class Settings(BaseSettings):
    ...
    cors_origins: str = (
        "http://localhost:3000,http://localhost:5173,http://127.0.0.1:5173,http://127.0.0.1:3000,http://localhost:8000,http://127.0.0.1:8000,https://landguard-eight.vercel.app,*"
    )
